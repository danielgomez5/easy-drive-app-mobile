...
val llistaAjudaClient = listOf<AjudaDades>(
    AjudaDades("Com puc registrar-me com a conductor?","Pots registrar-te com a conductor descarregant l’app de EasyDrive per a conductors i seguint els passos de registre. Necessitaràs documentació bàsica com el teu permís de conduir."),
    ...
    AjudaDades("Com demano un viatge programat per més tard?","Selecciones la opciò de “Reserva”, selecciones el destí final, cliques sobre “Reserva Taxi” allì pots escollir el dia i la hora de la reserva."),
    ...
    AjudaDades("Com cancel·lo un viatge com a clietn?","En el apartat de Reserves pendents n'hi han totes les teves reserves que estan pendents per confirma per un client o que està confirmat però encara el conductor no ha arribat, cliquem sobre la icona de la creu."),
)

val llistaAjudaTaxista = listOf<AjudaDades>(
    AjudaDades("Què faig si el passatger no es presenta?","Espera els 5 minuts de cortesia. Si no arriba, pots cancel·lar el viatge seleccionant “El passatger no s’ha presentat”. Podries rebre una compensació per temps d’espera."),
    ...
    AjudaDades("Com actualitzo la meva documentació?","Ves a la secció “Perfil” dins de l’app EasyDrive com a perfil de conductor. Des d’allà podràs pujar qualsevol document nou o renovat."),
    AjudaDades("Com faig que no estic disponible?","En la pantalla principal de l'aplicació n'hi ha un interruptor en qual pot posar si estas disponible o no."),
    AjudaDades("Hi ha un número d’atenció per a emergències?","Sí, pots trucar al 900 123 456 per emergències durant el servei, disponible 24/7."),
